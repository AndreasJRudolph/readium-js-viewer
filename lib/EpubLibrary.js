define(['jquery', 'bootstrap', 'storage/StorageManager', 'storage/Settings', 'EpubLibraryManager', 'i18n/Strings', 'hgn!templates/library-navbar.html',
    ...
    function ($, bootstrap, StorageManager, Settings, libraryManager, Strings, LibraryNavbar, LibraryBody, EmptyLibrary, LibraryItem, DetailsDialog, AboutDialog, DetailsBody, AddEpubDialog, ReaderSettingsDialog, Dialogs, Messages, Analytics, Keyboard, Versioning) {
	...
	var promptForReplace = function(originalData, replaceCallback, keepBothCallback){
        ...
        var loadLibraryUI = function () {
            ...
            $appContainer.empty();
            ReaderSettingsDialog.initDialog();
            ...
            $('#add-epub-dialog').on('shown.bs.modal', function () {
                ...
                setTimeout(function () {$('#closeAddEpubCross')[0].focus();}, 50);
            });
            ...
            $('#settings-dialog').on('shown.bs.modal', function () {
                ...
                setTimeout(function(){$('#closeSettingsCross')[0].focus(); }, 50);
